...
import com.evan.deadmansswitch.adapters.ContractsAdapter;
...
import com.evan.deadmansswitch.viewmodel.WalletViewModel;
...
public class WalletFragment extends Fragment implements
    ...
    private void initNetworkSpinner() {
        ...
        spinnerItems.add(Network.TEST_NET.getNetworkName());
