...
import com.evan.deadmansswitch.contract.DeadMansSwitch;
...
import com.evan.deadmansswitch.util.CustomGasProvider;
...
public class RemoteRepository {
    ...
    public DeadMansSwitch createSwitch(
        ...
        for (SendToRecipient sendToRecipient : sendToRecipients) {
            ...
            amountPerRecipient.add(sendToRecipient.getAmountLiskAsBigInt());
            totalAmountToSend = totalAmountToSend.add(sendToRecipient.getAmountLiskAsBigInt());
