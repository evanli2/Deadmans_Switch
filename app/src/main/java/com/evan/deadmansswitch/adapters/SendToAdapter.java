package com.evan.deadmansswitch.adapters;
...
public class SendToAdapter extends RecyclerView.Adapter<SendToAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int i) {
        ...
        if (list.get(i).getAmountLisk() == null) {
            holder.etAmountLsk.setText("");
        } else {
            holder.etAmountLsk.setText(list.get(i).getAmountLisk());
        }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements TextWatcher {
        ...
        @BindView(R.id.et_amount_lisk)
        TextInputEditText etAmountLsk;
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            etAmountLsk.addTextChangedListener(this);
