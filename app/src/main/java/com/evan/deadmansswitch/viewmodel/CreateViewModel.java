...
import com.evan.deadmansswitch.data.state.CreateUIState;
import com.evan.deadmansswitch.data.validator.CreateSwitchValidator;
...
public class CreateViewModel extends ViewModel {
    ...
    public void onAmountEditTextChange(int adapterPosition, CharSequence s) {
        list.get(adapterPosition).setAmountLisk(s);
    }
